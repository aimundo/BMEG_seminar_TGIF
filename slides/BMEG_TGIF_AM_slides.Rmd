---
title: "Generalized additive models for non-linear longitudinal biomedical data"
subtitle:
author: 
  - "Ariel Mundo"
...
class: center
This talk is based on work from our lab. Preprint is available in _bioRxiv_ <br>
...
[tinyurl.com/2p88nk7w](https://tinyurl.com/2p88nk7w)
...
The change of $y_{ijt}$ over time is represented by the _smooth function_ $f(time_t\mid \beta_j)$ with inputs as the covariates $time_t$ and parameters $\beta_j$ <br>
